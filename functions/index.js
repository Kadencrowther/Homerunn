          ...
          if (filters.beds && filters.beds.length > 0) {
            ...
            filters.beds.forEach(bed => {
              if (bed === '5+') {
                ...
                // For numeric beds, use "greater than or equal" to implement "X+" behavior
                bedFilters.push(`BedroomsTotal ge ${parseInt(bed)}`);
              }
            });
          ...
          if (filters.baths && filters.baths.length > 0) {
            ...
            filters.baths.forEach(bath => {
              if (bath === '5+') {
                ...
                // For numeric baths, use "greater than or equal" to implement "X+" behavior
                bathFilters.push(`BathroomsTotalInteger ge ${parseInt(bath)}`);
              }
            });
